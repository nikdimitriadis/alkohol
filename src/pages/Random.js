      ...
      {Object.keys(dataFromApi)?.map((key) => (
        ...
        >
          ...
          <div>
            ...
            <h3>Zutaten</h3>
            <p>{dataFromApi[key].strMeasure1}{dataFromApi[key].strIngredient1} </p>
            <p>{dataFromApi[key].strMeasure2}{dataFromApi[key].strIngredient2} </p>
            <p>{dataFromApi[key].strMeasure3}{dataFromApi[key].strIngredient3} </p>
            <p>{dataFromApi[key].strMeasure4}{dataFromApi[key].strIngredient4} </p>
            <p>{dataFromApi[key].strMeasure5}{dataFromApi[key].strIngredient5} </p>
            <p>{dataFromApi[key].strMeasure6}{dataFromApi[key].strIngredient6} </p>
